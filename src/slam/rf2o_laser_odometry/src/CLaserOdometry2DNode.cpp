  ...
  CLaserOdometry2D()
{
  ...
  laser_sub = n.subscribe<sensor_msgs::LaserScan>(laser_scan_topic,3,&CLaserOdometry2DNode::LaserCallBack,this);
...
bool CLaserOdometry2DNode::setLaserPoseFromTf()
{
  ...
  try
  {
    ...
    tf_listener.waitForTransform(base_frame_id,"laser",ros::Time(),ros::Duration(5.0));
    tf_listener.lookupTransform(base_frame_id, "laser", ros::Time(0), transform);
    retrieved = true;
  }
